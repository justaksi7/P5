...
# Project:  P5.pro
# Template: app
# Command: C:\Qt\6.5.2\mingw_64\bin\qmake.exe -o Makefile P5.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
Makefile: P5.pro C:/Qt/6.5.2/mingw_64/mkspecs/win32-g++/qmake.conf C:/Qt/6.5.2/mingw_64/mkspecs/features/spec_pre.prf \
